...
const array<std::uint32_t, 64> md5::s_array_ = {
...
//end of class and objects and array ||||. start of user input hashing
...
int main() {
    ...
    cout<<"            𝔻𝕆 𝕐𝕆𝕌 𝕎𝔸ℕ𝕋 𝕋𝕆 ℍ𝔸𝕊ℍ!   "<<endl;
    
    //enterpoint of our code
    cout<<"🔰🅤🅢🅔 🅞🅝🅛🅨 🅢🅜🅐🅛🅛 🅛🅔🅣🅣🅔🅡 🅣🅞 🅔🅝🅣🅔🅡🔰"<<endl;
    cout<<"  "<<endl;
    cout<<" 🇾‌🇪‌🇸‌"<<endl;
    cout<<" 🇳‌🇴"<<endl;
  ...
  while(1==1){
    ...
    cout<<" ᙓᑎTᙓᖇ YOᙀᖇ ᑭᗩSSᙎOᖇᗪ TO ᕼᗩSᕼ--> "<<" ";
    string data;
    cin>>data;
    ...
    cout <<" 𝕐𝕠𝕦𝕣 𝕙𝕒𝕤𝕙== "<< data_hex_digest << endl;
 }

}

else{
  cout<<"𝕋𝕙𝕒𝕟𝕜𝕪𝕠𝕦 𝕗𝕠𝕣 𝕧𝕚𝕤𝕚𝕥𝕚𝕟𝕘"<<endl;
  cout<<"🅖🅞🅞🅓🅑🅨🅔 🅗🅐🅥🅔 🅐 🅖🅞🅞🅓 🅓🅐🅨"<<endl;
